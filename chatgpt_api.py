...
if __name__ == "__main__":
    # Replace 'Hello, how are you?' with any message you want to send
    main("Can you write the introduction for this song: Ama by Extremoduro, as if you were the author of a rock music blog? You can omit the introduction from the response, I just want the text for the blog, and the response should be no more than 30 words.")